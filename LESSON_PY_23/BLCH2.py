...
class BlockChain:
    ...
    def createGenesisBlock(self):
        return Block(0, "10/01/2022", "Genesis Block", "0")
...
def main():
    annaCoin = BlockChain()
    annaCoin.addBlock(Block(1, "10/10/2022", {"account": "Anna","amount": 25,"action": "buy"}))
    annaCoin.addBlock(Block(2, "11/01/2022", {"account": "Joe","amount": 10,"action": "buy"}))
    annaCoin.addBlock(Block(3, "12/01/2022", {"account": "Katie","amount": 20,"action": "buy"}))
    annaCoin.addBlock(Block(4, "12/07/2022", {"account": "Ethan","amount": 4,"action": "buy"}))
