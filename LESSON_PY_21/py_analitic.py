"""
методы простой экстраполяции, метод скользящих средних,
метод экспоненциального сглаживания, метод среднего абсолютного прироста,
метод среднего темпа роста,
методы прогнозирования на основе математических моделей
